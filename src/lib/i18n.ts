...
const dict = {
  ar: {
    ...
    accountInfo: "معلومات الحساب", changePwd: "تغيير كلمة المرور", help: "مركز المساعدة", about: "عن التطبيق", terms: "شروط الاستخدام",
    ...
    groupName: "اسم المجموعة", channelName: "اسم القناة",
    typing: "يكتب...", recording: "جاري التسجيل...", stop: "إيقاف",
    publish: "نشر", attach: "إرفاق",
    msgReply: "رد", msgForward: "إعادة توجيه", msgCopy: "نسخ", msgTranslate: "ترجمة",
    ...
    myReports: "بلاغاتي",
    myReportsHint: "البلاغات التي قدّمتها وحالة مراجعتها",
  ...
  en: {
    ...
    accountInfo: "Account Info", changePwd: "Change Password", help: "Help Center", about: "About", terms: "Terms of Use",
    ...
    groupName: "Group name", channelName: "Channel name",
    typing: "typing...", recording: "Recording...", stop: "Stop",
    publish: "Publish", attach: "Attach",
    msgReply: "Reply", msgForward: "Forward", msgCopy: "Copy", msgTranslate: "Translate",
    ...
    myReportsHint: "Reports you submitted and their review status",
