import { r as registerPlugin, a as apiFetch, i as isNativeCapacitorShell, b as routePushNotificationTap, C as Capacitor } from "./index-DOKOZTH2.js";
import "./server-CwkBbFjQ.js";
import "node:async_hooks";
import "node:stream/web";
import "node:stream";
import "fs";
import "url";
import "./worker-entry-B0L4pACP.js";
import "node:events";
import "http";
import "https";
import "./router-CFFoT6fT.js";
import "util";
import "stream";
import "zlib";
import "assert";
...
async function apiRegisterPushToken(token, platform) {
  const authToken = (await import("./index-DOKOZTH2.js").then((n) => n.c)).getApiToken();
