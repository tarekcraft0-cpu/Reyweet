...
<html lang="ar" dir="rtl">
  <head>
    ...
    <style>
      body { font: 15px/1.6 system-ui, -apple-system, sans-serif; background: #fafafa; color: #111; display: grid; place-items: center; min-height: 100vh; margin: 0; padding: 1.5rem; }
  ...
  <body>
    <div class="card">
      ...
      <p>حدث خطأ أثناء التحميل. جرّب تحديث الصفحة أو ارجع للرئيسية.</p>
      <div class="actions">
...
async function getServerEntry() {
  if (!serverEntryPromise) {
    serverEntryPromise = import("./server-Bhfd37SK.js").then((n) => n.a4).then(
      (m) => m.default ?? m
    );
  }
